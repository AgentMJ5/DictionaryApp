...
import com.example.jathinvarma.fragments.FragmentAntonyms;
import com.example.jathinvarma.fragments.FragmentDefinition;
import com.example.jathinvarma.fragments.FragmentExample;
import com.example.jathinvarma.fragments.FragmentSynonyms;
...
public class Word_MeaningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word__meaning);
        ...
        btnSpeak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                tts = new TextToSpeech(Word_MeaningActivity.this, new TextToSpeech.OnInitListener() {
                    @Override
        ...
        android.support.v7.widget.Toolbar toolbar = (Toolbar) findViewById(R.id.sToolbar);
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        private final List<Fragment> oneFragmentList = new ArrayList<>();
        private final List<String> oneFragmenttitleList = new ArrayList<>();
        ...
        void addFrag(Fragment fragment, String title) {
            oneFragmentList.add(fragment);
            oneFragmenttitleList.add(title);
        }
        ...
        @Override
        public int getCount() {
            return oneFragmentList.size();
        }

        @Override
        public CharSequence getPageTitle(int position) {
            return oneFragmenttitleList.get(position);
        }
